...
struct mem_arena_loops_config {
    ...
    int enable_touch_sampling;
    uint32_t hotness_tick_ms;
    uint32_t sampling_tick_ms;
    uint32_t compression_tick_ms;
    uint32_t prefetch_tick_ms;
    uint32_t sampling_budget_pages;
...
struct mem_arena_stats {
    ...
    uint64_t sampling_pages_armed;
    uint64_t sampling_faults_total;
    uint64_t sampling_faults_dropped;
